  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          {/* Header Section */}
          <div className="bg-gradient-to-r from-violet-600/10 to-fuchsia-600/10 border-b border-slate-800 p-8 sm:p-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-800">
                ...
                <p className="text-lg font-semibold text-white">{job.location}</p>
              </div>
            </div>
          </div>
            ...
            {user && user.role !== "Employer" && (
              ...
              >
                <Link
                  ...
                  className="flex items-center justify-center gap-3 w-full py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white text-lg font-semibold rounded-xl hover:from-violet-500 hover:to-fuchsia-500 transition-all duration-300 shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 group"
                >
        ...
        <motion.div
          ...
          className="mt-8 p-6 bg-slate-900/30 border border-slate-800 rounded-xl"
        >
