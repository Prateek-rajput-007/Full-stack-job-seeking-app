      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {companies.map((company, index) => (
            ...
            >
              <div className="relative h-full bg-slate-900/40 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 hover:border-violet-500/30 transition-all duration-500 flex flex-col items-center text-center">
                ...
                {/* Icon */}
                <div className={`w-20 h-20 rounded-2xl ${company.bg} flex items-center justify-center text-4xl mb-6 shadow-xl shadow-slate-950/50 group-hover:scale-110 transition-transform duration-500`}>
                ...
                {/* Content */}
                <h3 className="text-2xl font-bold text-white mb-2">{company.title}</h3>
                ...
                <button className="w-full py-4 rounded-xl bg-slate-800 text-white font-medium border border-slate-700 hover:border-violet-500/50 hover:bg-slate-700 transition-all duration-300 flex items-center justify-between px-6 group/btn mt-auto">
